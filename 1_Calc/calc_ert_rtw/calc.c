...
void calc_step(void)
{
   ...
   *  Sum: '<Root>/Add'
   */
  calc_Y.Out1 = calc_U.Input + calc_U.Input1;
   ...
   *  Sum: '<Root>/Subtract'
   */
  calc_Y.Out2 = calc_U.Input - calc_U.Input1;
   ...
   *  Outport: '<Root>/Out3'
   */
  tmp = (uint32_T)calc_U.Input;
  tmp_0 = (uint32_T)calc_U.Input1;
  sMultiWordMul(&tmp, 1, &tmp_0, 1, &calc_Y.Out3.chunks[0U], 2);
   ...
   *  Product: '<Root>/Divide'
   */
  calc_Y.Out4 = div_s32_floor(calc_U.Input, calc_U.Input1);
}
