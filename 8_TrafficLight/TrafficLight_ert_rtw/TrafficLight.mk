###########################################################################
## Makefile generated for Simulink model 'TrafficLight'. 
## 
## Makefile     : TrafficLight.mk
## Generated on : Wed Mar 30 16:38:57 2022
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\TrafficLight.exe
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\TrafficLight.exe
...
SRCS = $(START_DIR)\TrafficLight_ert_rtw\TrafficLight.c
...
{$(START_DIR)\TrafficLight_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\TrafficLight_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
TrafficLight.obj : $(START_DIR)\TrafficLight_ert_rtw\TrafficLight.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\TrafficLight_ert_rtw\TrafficLight.c


ert_main.obj : $(START_DIR)\TrafficLight_ert_rtw\ert_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\TrafficLight_ert_rtw\ert_main.c
