...
MODEL                   = TrafficLight
MODULES                 = rt_logging.c TrafficLight.c TrafficLight_capi.c TrafficLight_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = TrafficLight.exe
...
MASTER_ANCHOR_DIR       = 
START_DIR               = D:\ITI\12_MBD\Tasks\8_TrafficLight
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = TrafficLight_ref.rsp
...
rtiostream_utils.obj : "C:\Program Files\Polyspace\R2020a\toolbox\coder\rtiostream\src\utils\rtiostream_utils.c"
	@cmd /C "echo ### Compiling "C:\Program Files\Polyspace\R2020a\toolbox\coder\rtiostream\src\utils\rtiostream_utils.c"
	$(CC) $(CFLAGS) "C:\Program Files\Polyspace\R2020a\toolbox\coder\rtiostream\src\utils\rtiostream_utils.c"
